...
class AdminController extends AbstractController
{
    ...
    public function new_password(Request $request,UserRepository $userRepository,EntityManagerInterface $manager, UserPasswordHasherInterface $hasher, $id): Response
    {
        //en théorie un champs token devrrait exister en BDD, token qui aurait été généré à la demande de réinitialisation ainsi qu'une date d'expiration
        //
        if(!empty($_POST))
        {
